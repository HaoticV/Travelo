package com.example.travelo.libs;
...
public class CustomSliderView extends FrameLayout {
    ...
    private CustomCircularSliderHandle mCircularSliderHandle;
    ...
    private void setupSlideView(Context context) {
        ...
        mCircularSliderHandle = new CustomCircularSliderHandle(mSliderPager);
    ...
    public void setCurrentPageListener(CustomCircularSliderHandle.CurrentPageListener listener) {
